...
builder.Services.AddTransient<IProductSV, ProductSV>();

builder.Services.AddTransient<IBrandRepo, BrandRepo>();
builder.Services.AddTransient<IBrandSV, BrandSV>();

builder.Services.AddTransient<ICategoryRepo, CategoryRepo>();
builder.Services.AddTransient<ICategorySV, CategorySV>();
